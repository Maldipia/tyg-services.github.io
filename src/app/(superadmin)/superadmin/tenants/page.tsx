      ...
      {loading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {filtered.map(t => {
            ...
            return (
              <div key={t.id} className="rounded-2xl p-5 flex flex-col gap-4"
                ...
                <div className="flex items-center justify-between">
                  ...
                  {isTrial && (
                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl"
                      style={{ background: days <= 3 ? 'rgba(239,68,68,0.1)' : 'rgba(245,158,11,0.1)', border: `1px solid ${days <= 3 ? 'rgba(239,68,68,0.2)' : 'rgba(245,158,11,0.2)'}` }}>
                ...
                <Link href={`/superadmin/tenants/${t.slug}`}
                  ...
                  style={{ background: 'rgba(124,58,237,0.12)', color: '#a78bfa', textDecoration: 'none', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {filtered.length === 0 && (
            <div className="col-span-3 text-center py-16" style={{ color: 'rgba(255,255,255,0.3)', fontSize: 14 }}>
